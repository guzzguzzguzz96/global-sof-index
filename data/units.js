...
const rawUnits = [
      ...
      {c:"South America", country:"Peru", code:"CEV", name:"Comando Especial VRAEM (CE-VRAEM)", tier:"A", role:"Jungle warfare and counter-insurgency missions", tags:["Jungle","Direct Action","Recon"], sel:90, multi:89, env:98},
      ...
      {c:"South America", country:"Uruguay", code:"CEA", name:"Compañía Especial Antiterrorista “Escorpión” (CEAT)", tier:"B", role:"National counter-terror response", tags:["Counter Terror","Urban","Hostage Rescue"], sel:85, multi:83, env:84},
      {c:"South America", country:"Venezuela", code:"BAE", name:"Unidad de Apoyo a la Investigación (BAE)", tier:"B", role:"Special action and internal security missions", tags:["Direct Action","Urban","Recon"], sel:86, multi:84, env:88},
      ...
      {c:"Oceania", country:"Samoa", code:"TRG", name:"Samoa Police Tactical Operations Section", tier:"B", role:"Island tactical response and protective security", tags:["Urban","Counter Terror","Maritime"], sel:76, multi:74, env:88},
...
const minimumDossiers = {
  ...
  "Kenya::RSF": {
    founded: "No confirmed founding date; the 'Ranger Strike Force' designation traces to a U.S.-assisted development programme, not a documented unit establishment date",
    branch: "Kenya Defence Forces (KDF)",
    unitType: "Kenya Defence Forces ranger / light infantry unit",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "หน่วยที่ฐานข้อมูลนี้ติดตามภายใต้รหัส RSF (Ranger Strike Force) เชื่อมโยงกับพัฒนาการของกำลังเรนเจอร์ของ Kenya Defence Forces (KDF) โดยชื่อ 'Ranger Strike Force' เป็นชื่อของโครงการพัฒนาขีดความสามารถที่ได้รับการสนับสนุนจากสหรัฐฯ (ผ่าน AFRICOM/SOCAFRICA) มิใช่ชื่อทางการปัจจุบันของหน่วยที่ปฏิบัติภารกิจอยู่ ตามข้อมูลที่เปิดเผยต่อสาธารณะ หน่วยเรนเจอร์ที่ปรากฏในเอกสารทางการปัจจุบันคือ 40 Ranger Battalion (เอกสารของสหรัฐฯ ใช้รูป 40th Ranger Battalion) ซึ่งเป็นหน่วยของ KDF เอกสารทางการของกระทรวงกลาโหมเคนยาปี 2025 อ้างถึงกองร้อย Delta ของ 40 Ranger Battalion ที่วางกำลังภายใต้ Operation Amani Boni และการทดสอบสมรรถภาพเรนเจอร์ประจำปี ขณะที่เอกสารภาพทางการของกระทรวงกลาโหมสหรัฐฯ (DVIDS) ในการฝึก Justified Accord 2026 ระบุกำลังพลของ 40th Ranger Battalion ในสังกัด Kenya Defence Forces บทบาทที่เปิดเผยต่อสาธารณะเน้นภารกิจแบบเรนเจอร์/ทหารราบเบา การปฏิบัติการความมั่นคงภายใน และการฝึกร่วมกับกองทัพมิตรประเทศ ทั้งนี้ไม่ควรนำวันของโครงการช่วยเหลือมาใช้เป็นวันก่อตั้งหน่วย ไม่ควรรวมโครงการ Ranger Strike Force ในอดีตกับ 40 Ranger Battalion ปัจจุบันเป็นองค์กรเดียวกันโดยอัตโนมัติ และรายละเอียดกำลังพล อาวุธ หน่วยต้นสังกัดที่ละเอียดกว่าระดับ KDF และการปฏิบัติการเฉพาะไม่ได้รับการยืนยันจากแหล่งทางการที่เข้าถึงได้" },
    sources: [
      { title: "A Test of Endurance, Teamwork, and Resilience", publisher: "Ministry of Defence, Republic of Kenya (mod.go.ke)", url: "https://www.mod.go.ke/news/a-test-of-endurance-teamwork-and-resilience/", type: "government", accessedAt: "2026-07-14", supports: ["identity", "branch", "role"], notes: "หน้าข่าวทางการของกระทรวงกลาโหมเคนยา อ้างถึงกองร้อย Delta ของ 40 Ranger Battalion ที่วางกำลังภายใต้ Operation Amani Boni และการทดสอบสมรรถภาพเรนเจอร์ประจำปี สนับสนุนชื่อหน่วยปัจจุบัน (40 Ranger Battalion) การสังกัด Kenya Defence Forces และบทบาทเรนเจอร์/ความมั่นคงภายใน (ไม่ระบุวันก่อตั้ง)" },
      { title: "US infantry, Kenya Defense Forces rangers conclude bilateral live-fire training during Justified Accord 2026", publisher: "U.S. Department of Defense — DVIDS", url: "https://www.dvidshub.net/image/9568226/us-infantry-kenya-defense-forces-rangers-conclude-bilateral-live-fire-training-during-justified-accord-2026", type: "official", accessedAt: "2026-07-14", supports: ["identity", "branch"], notes: "คำบรรยายภาพทางการของกระทรวงกลาโหมสหรัฐฯ (DVIDS) จากการฝึก Justified Accord 2026 ระบุกำลังพลของ 40th Ranger Battalion ในสังกัด Kenya Defence Forces (มีนาคม 2026) ยืนยันชื่อหน่วยปัจจุบันและเหล่าทัพต้นสังกัดแบบอิสระ (ไม่สนับสนุนวันก่อตั้งหรือชื่อ Ranger Strike Force)" },
      { title: "AFRICOM Posture Statement: Ward Reports Annual Testimony to Congress", publisher: "U.S. Army (army.mil) — U.S. Africa Command", url: "https://www.army.mil/article/35595/africom_posture_statement_ward_reports_annual_testimony_to_congress", type: "official", accessedAt: "2026-07-14", supports: ["history"], notes: "เอกสารเผยแพร่ทางการของกองทัพบกสหรัฐฯ (สำเนาแถลงการณ์ท่าที AFRICOM ปี 2010 ของ Gen. William Ward) สนับสนุนข้อความประวัติศาสตร์ว่า U.S. Africa Command (ผ่าน SOCAFRICA) ให้ความช่วยเหลือในการจัดตั้ง Ranger Strike Force ในเคนยา และได้ฝึกกองร้อยของ Kenyan Ranger Strike Force จำนวนสองกองร้อย ('assisting in establishing a Ranger Strike Force' / 'completed training two companies of the Kenyan Ranger Strike Force') เป็นบริบทโครงการช่วยเหลือ มิใช่วันก่อตั้งหน่วย การเข้าถึงอัตโนมัติถูกบล็อก HTTP 403 จึงยืนยันเนื้อหาผ่านการค้นคืนของเครื่องมือค้นหา" },
    ],
  },
  "Uganda::SFC": {
    founded: "Current 'Special Forces Command' designation adopted in 2012; organizational roots trace to the High Command Unit established in May 1981",
    branch: "Uganda People's Defence Force (UPDF) — Special Forces Command",
    unitType: "UPDF special operations command / service",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "Special Forces Command (SFC) เป็นองค์ประกอบเฉพาะทางของกองกำลังป้องกันประชาชนยูกันดา (Uganda People's Defence Force; UPDF) ทำหน้าที่ปฏิบัติภารกิจพิเศษและประสานงานกับกำลังทางบก (Land Forces) และกำลังทางอากาศ (Air Forces) ของ UPDF ตามพันธกิจที่หน่วยเผยแพร่อย่างเป็นทางการคือการพัฒนาและใช้กำลังปฏิบัติการพิเศษที่ทรงพลังและยืดหยุ่นซึ่งสอดคล้องกับแนวทางการสงครามเฉพาะของยูกันดาและตอบสนองความต้องการของ UPDF และของชาติ สายเชื้อสายขององค์กรควรแยกเป็นช่วงอย่างชัดเจน ได้แก่ High Command Unit (HCU) ที่จัดตั้งในเดือนพฤษภาคม 1981 ต่อมาเปลี่ยนชื่อเป็น Presidential Protection Unit (PPU) หลังปี 1986 แล้วขยาย/เปลี่ยนรูปเป็นหน่วยที่ใหญ่ขึ้นในเวลาต่อมา จากนั้นเป็น Special Forces Group ในปี 2010 และได้รับการกำหนดเป็น Special Forces Command ในปี 2012 ดังนั้นปี 1981 เป็นเพียงรากทางประวัติศาสตร์ มิใช่วันจัดตั้งองค์กรภายใต้ชื่อ Special Forces Command ปัจจุบัน หน่วยมีที่ตั้งกองบัญชาการที่เมือง Entebbe เขต Wakiso ทั้งนี้รายละเอียดกำลังพล อาวุธ การจัดหน่วย และการปฏิบัติการเฉพาะไม่ได้เปิดเผยต่อสาธารณะ และไม่นำประเด็นทางการเมืองมาประกอบ" },
    sources: [
      { title: "About Us — Special Forces Command", publisher: "Special Forces Command (Uganda) — sfc.go.ug", url: "https://sfc.go.ug/about/about-us", type: "official", accessedAt: "2026-07-14", supports: ["identity", "branch", "role"], notes: "เว็บไซต์ทางการรองของ Special Forces Command (โหลดได้ HTTP 200) ยืนยันสถานะการเป็นองค์ประกอบเฉพาะทางของ UPDF พันธกิจทางการของหน่วย การประสานงานกับกำลังทางบก/ทางอากาศ และที่ตั้งกองบัญชาการที่ Entebbe เขต Wakiso" },
      { title: "Special Forces Command — SFC Brief History", publisher: "Ministry of Defence and Veterans Affairs / UPDF (Uganda) — defence.go.ug", url: "https://www.defence.go.ug/joint-updf-services/updf-services/special-forces-command/sfc-brief-history/", type: "official", accessedAt: "2026-07-14", supports: ["history"], notes: "หน้าประวัติทางการของกระทรวงกลาโหมยูกันดา/UPDF สนับสนุนสายเชื้อสายเป็นช่วง (HCU พฤษภาคม 1981 → PPU หลังปี 1986 → Special Forces Group 2010 → Special Forces Command 2012) โดยระบุว่า SFC 'metamorphosed out of the High Command Unit' (การเข้าถึงอัตโนมัติถูกปฏิเสธ ECONNREFUSED จึงยืนยันเนื้อหาผ่านการค้นคืนของเครื่องมือค้นหา)" },
    ],
  },
  "Ghana::SBS": {
    founded: "Established in 2016 (as stated by the official Ghana Navy)",
    branch: "Ghana Navy",
    unitType: "Ghana Navy maritime special operations squadron",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "Ghana Navy Special Boat Squadron (SBS) เป็นหน่วยปฏิบัติการพิเศษทางทะเลของกองทัพเรือกานา (Ghana Navy) เว็บไซต์ทางการของกองทัพเรือกานาระบุว่าหน่วยนี้ 'ถูกจัดตั้งขึ้นในปี 2016' และจัดอยู่ในโครงสร้าง Naval Corps ของกองทัพเรือ ชื่อทางการที่แหล่งข้อมูลใช้คือ Special Boat Squadron (มิใช่ Special Boat Service) บทบาทที่หน่วยเผยแพร่อย่างเป็นทางการครอบคลุมการต่อต้านโจรสลัดและการปล้นในทะเล การขึ้นตรวจค้นและยึด (Visit, Board, Search and Seizure; VBSS) กับเรือที่ไม่ให้ความร่วมมือ การปฏิบัติการพิเศษเพื่อปกป้องสิ่งปลูกสร้างทางทะเลเชิงยุทธศาสตร์ การลาดตระเวนพิเศษ และการค้นหาและกู้ภัยในการรบ (Combat Search and Rescue; CSAR) เอกสารทางการของกองทัพกานาปี 2026 ยังกล่าวถึงการฝึกที่ผสานการเฝ้าตรวจด้วยอากาศยานไร้คนขับเข้ากับการปฏิบัติการสกัดกั้นทางทะเล ในบริบทความมั่นคงทางทะเลของอ่าวกินี มีรายงานว่าสหรัฐฯ ได้ขยายการฝึกและการสนับสนุนแก่กองทัพเรือกานาเพื่อยกระดับขีดความสามารถนอกชายฝั่ง อย่างไรก็ตามยุทโธปกรณ์ที่ได้รับบริจาค (เช่น เรือที่สหรัฐฯ มอบให้) ถือเป็นความช่วยเหลือ มิใช่บัญชียุทโธปกรณ์ประจำการของหน่วย และไม่ควรอนุมานบทบาทหรือขีดความสามารถลับจากภาพการฝึก รายละเอียดกำลังพลและการจัดหน่วยไม่ได้เปิดเผยต่อสาธารณะ" },
    sources: [
      { title: "Special Boat Squadron — Naval Corps", publisher: "Ghana Navy (navyonline.mil.gh)", url: "https://navyonline.mil.gh/naval-corps/special-boat-squadron", type: "official", accessedAt: "2026-07-14", supports: ["identity", "branch", "history", "role"], notes: "หน้าหน่วยทางการของกองทัพเรือกานา (โหลดได้) ยืนยันชื่อ Special Boat Squadron การสังกัด Ghana Navy (โครงสร้าง Naval Corps) คำระบุว่าหน่วยถูกจัดตั้งขึ้นในปี 2016 และรายการบทบาท (ต่อต้านโจรสลัด, VBSS, ปกป้องสิ่งปลูกสร้างทางทะเล, ลาดตระเวนพิเศษ, CSAR)" },
      { title: "SBS Conducts Drone-Supported Exercise", publisher: "Ghana Armed Forces (gafonline.mil.gh)", url: "https://gafonline.mil.gh/blog-details/sbs-conducts-drone-supported-exercise", type: "official", accessedAt: "2026-07-14", supports: ["identity", "role"], notes: "หน้าข่าวทางการของกองทัพกานา ใช้ชื่อ Ghana Navy Special Boat Squadron (SBS) และอธิบายการผสานการเฝ้าตรวจด้วยอากาศยานไร้คนขับเข้ากับการปฏิบัติการสกัดกั้นทางทะเล (Exercise BLUE SCREEN, 20 กุมภาพันธ์ 2026) การเข้าถึงอัตโนมัติถูกบล็อก HTTP 403 จึงยืนยันเนื้อหาผ่านการค้นคืนของเครื่องมือค้นหา" },
      { title: "U.S. Extends Training and Support for Ghana Navy — $6 million in equipment projects and training to help improve maritime security", publisher: "U.S. Embassy in Ghana (gh.usembassy.gov)", url: "https://gh.usembassy.gov/u-s-extends-training-and-support-for-ghana-navy-6-million-in-equipment-projects-and-training-to-help-improve-maritime-security/", type: "government", accessedAt: "2026-07-14", supports: ["identity", "branch"], notes: "แหล่งข้อมูลรัฐบาลพันธมิตร (สถานทูตสหรัฐฯ ประจำกานา) ใช้ชื่อ Ghana Navy Special Boat Squadron (SBS) ยืนยันการสังกัดกองทัพเรือกานา และบริบทความมั่นคงทางทะเลอ่าวกินี (โจรสลัด/การประมงผิดกฎหมาย) ยุทโธปกรณ์ที่กล่าวถึงเป็นการบริจาคเพื่อช่วยเหลือ มิใช่บัญชีประจำการของหน่วย" },
    ],
  },
  "Brazil::COPESP": {
    founded: "Current 'Comando de Operações Especiais' designation adopted by Army Commander Ordinance (Portaria) No. 142 on 13 March 2013; predecessor Brigada de Operações Especiais created by Presidential Decree No. 4,289 on 27 June 2002",
    branch: "Brazilian Army (Exército Brasileiro) — directly subordinate to Comando Militar do Planalto (CMP)",
    unitType: "Army special operations command",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "Comando de Operações Especiais (ใช้อักษรย่อทางการว่า COpEsp) เป็นหน่วยบัญชาการปฏิบัติการพิเศษของกองทัพบกบราซิล (Exército Brasileiro) มีที่ตั้งที่เมือง Goiânia รัฐ Goiás สายพัฒนาการขององค์กรควรแยกเป็นสองช่วงอย่างชัดเจน คือ Brigada de Operações Especiais (กองพลน้อยปฏิบัติการพิเศษ) ซึ่งจัดตั้งโดยพระราชกฤษฎีกาประธานาธิบดีเลขที่ 4.289 ลงวันที่ 27 มิถุนายน 2002 ภายใต้แผนปรับโครงสร้างกองทัพบก และต่อมาได้เปลี่ยนการกำหนดหน่วยเป็น Comando de Operações Especiais ตามคำสั่ง (Portaria) ของผู้บัญชาการทหารบกเลขที่ 142 ลงวันที่ 13 มีนาคม 2013 ดังนั้นจึงไม่ควรระบุว่าองค์กรภายใต้ชื่อ Comando de Operações Especiais ปัจจุบันถูกจัดตั้งในปี 2002 โดยไม่อธิบายการเปลี่ยนการกำหนดหน่วยในปี 2013 ตามข้อมูลที่เปิดเผยต่อสาธารณะ หน่วยขึ้นการบังคับบัญชาโดยตรงต่อ Comando Militar do Planalto (CMP) และเชื่อมโยงกับ Comando de Operações Terrestres (COTER) ในด้านการเตรียมและการใช้กำลัง (preparo e emprego) โดยกำลังหลักของหน่วยสนับสนุน Força de Ação Rápida Estratégica และการปฏิบัติของกองบัญชาการทหารพื้นที่ต่าง ๆ ของกองทัพบก ทั้งนี้รายละเอียดกำลังพล อาวุธ และการจัดหน่วยรองแบบละเอียดไม่ได้นำมารวมไว้" },
    sources: [
      { title: "Institucional — Histórico", publisher: "Comando de Operações Especiais — Exército Brasileiro (copesp.eb.mil.br)", url: "https://www.copesp.eb.mil.br/index.php/institucional/historico", type: "official", accessedAt: "2026-07-14", supports: ["identity", "history", "branch", "role"], notes: "หน้าประวัติทางการของ COpEsp สนับสนุนตัวตน อักษรย่อ COpEsp การจัดตั้ง Brigada de Operações Especiais โดย Decreto 4.289 (27 มิ.ย. 2002) การเปลี่ยนการกำหนดหน่วยเป็น Comando de Operações Especiais โดย Portaria 142 (13 มี.ค. 2013) และการสนับสนุน Força de Ação Rápida Estratégica (การเข้าถึงอัตโนมัติถูกรีเซ็ตการเชื่อมต่อ ECONNRESET จึงยืนยันเนื้อหาผ่านการค้นคืนของเครื่องมือค้นหา)" },
      { title: "Institucional — Subordinação", publisher: "Comando de Operações Especiais — Exército Brasileiro (copesp.eb.mil.br)", url: "https://www.copesp.eb.mil.br/index.php/institucional/subordinacao", type: "official", accessedAt: "2026-07-14", supports: ["branch"], notes: "หน้าโครงสร้างการขึ้นตรงทางการของ COpEsp สนับสนุนการขึ้นการบังคับบัญชาโดยตรงต่อ Comando Militar do Planalto (CMP) และความเชื่อมโยงด้านการเตรียม/การใช้กำลังกับ COTER (การเข้าถึงอัตโนมัติถูกรีเซ็ตการเชื่อมต่อ ECONNRESET จึงยืนยันเนื้อหาผ่านการค้นคืนของเครื่องมือค้นหา)" },
      { title: "Decreto nº 4.289, de 27 de junho de 2002", publisher: "Presidência da República do Brasil (planalto.gov.br)", url: "https://www.planalto.gov.br/ccivil_03/decreto/2002/d4289.htm", type: "official", accessedAt: "2026-07-14", supports: ["history"], notes: "กฎหมายปฐมภูมิของบราซิล (พระราชกฤษฎีกาเลขที่ 4.289) สนับสนุนข้อเท็จจริงการจัดตั้ง Brigada de Operações Especiais เมื่อ 27 มิถุนายน 2002 (มิใช่วันจัดตั้งองค์กรภายใต้ชื่อ Comando de Operações Especiais ปัจจุบัน; การเข้าถึงอัตโนมัติถูกรีเซ็ตการเชื่อมต่อ จึงยืนยันเนื้อหาผ่านการค้นคืนของเครื่องมือค้นหา)" },
    ],
  },
  "Colombia::AFEAU": {
    branch: "Colombian military (Fuerzas Militares de Colombia) — urban counter-terrorism special forces; published by both the Ejército Nacional and the Comando General de las Fuerzas Militares (CGFM)",
    unitType: "Urban counter-terrorism special forces group",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "Agrupación de Fuerzas Especiales Antiterroristas Urbanas เป็นหน่วยกำลังรบพิเศษด้านการต่อต้านการก่อการร้ายในเขตเมืองของกองทัพโคลอมเบีย แหล่งข้อมูลทางการของกองทัพโคลอมเบียใช้ทั้งอักษรย่อ AFEAU และ AFEUR สำหรับชื่อ Agrupación de Fuerzas Especiales Antiterroristas Urbanas โดยพบการใช้ AFEAU ทั้งในหน้าของ Comando General de las Fuerzas Militares (CGFM) และในหน้าข่าวของกองทัพบก (Ejército Nacional) ขณะที่หน้าข่าวของกองทัพบกบางหน้าใช้รูป AFEUR เอกสารสาธารณะที่ตรวจสอบได้ยังไม่อธิบายความแตกต่างระหว่างอักษรย่อทั้งสองอย่างชัดเจน ฐานข้อมูลนี้จึงคง AFEAU ไว้ตาม key เดิมและตามการใช้ในแหล่งทางการของ Comando General de las Fuerzas Militares โดยไม่สรุปว่าอักษรย่อทั้งสองสื่อถึงระดับองค์กรที่ต่างกัน เป็นคนละหน่วย เป็นหน่วยเดียวกัน หรือมีความสัมพันธ์เชิงโครงสร้างแบบหน่วยเหนือ/หน่วยรองระหว่างกัน บทบาทตามชื่อทางการคือการต่อต้านการก่อการร้ายในเขตเมือง ทั้งนี้เนื้อหาหน้าเว็บของแหล่งทางการถูกบล็อกการเข้าถึงอัตโนมัติ (HTTP 403) จึงยืนยันได้เฉพาะชื่อและอักษรย่อผ่านหัวเรื่องที่ถูกจัดทำดัชนี ส่วนข้ออ้างเรื่องการช่วยตัวประกัน การอารักขาบุคคลสำคัญ การปฏิบัติต่อเป้าหมายมูลค่าสูง โครงสร้างร่วมสามเหล่าทัพ (Alfa/Bravo/Charly) และปีก่อตั้ง ยังไม่มีแหล่งทางการปฐมภูมิที่ตรวจสอบเนื้อหาได้ จึงไม่นำมารวมไว้" },
    sources: [
      { title: "Agrupación de Fuerzas Especiales Antiterroristas Urbanas — AFEAU", publisher: "Comando General de las Fuerzas Militares de Colombia (cgfm.mil.co)", url: "https://www.cgfm.mil.co/es/taxonomy/term/5138", type: "official", accessedAt: "2026-07-14", supports: ["identity"], notes: "หน้าทางการของ Comando General de las Fuerzas Militares (CGFM) ใช้ชื่อเต็ม Agrupación de Fuerzas Especiales Antiterroristas Urbanas พร้อมอักษรย่อ AFEAU (เนื้อหาหน้าเว็บถูกบล็อก HTTP 403 จึงยืนยันชื่อ/อักษรย่อผ่านหัวเรื่องที่ถูกจัดทำดัชนี)" },
      { title: "Agrupación de Fuerzas Especiales Antiterroristas", publisher: "Ejército Nacional de Colombia (ejercito.mil.co)", url: "https://www.ejercito.mil.co/agrupacion-de-fuerzas-especiales-antiterroristas/", type: "official", accessedAt: "2026-07-14", supports: ["identity", "branch"], notes: "หน้าหน่วยทางการของกองทัพบกโคลอมเบีย สนับสนุนชื่อทางการของหน่วยและบริบทการเป็นหน่วยของกองทัพบกโคลอมเบีย (เนื้อหาหน้าเว็บถูกบล็อก HTTP 403 จึงยืนยันชื่อผ่านหัวเรื่องที่ถูกจัดทำดัชนี; หน้านี้ไม่ได้ใช้ยืนยันรูปอักษรย่อใดอักษรย่อหนึ่ง)" },
      { title: "AFEAU, champions of the CCOES Warrior Competition 2019", publisher: "Ejército Nacional de Colombia (ejercito.mil.co)", url: "https://www.ejercito.mil.co/afeau-champions-of-the-ccoes-warrior-competition-2019/", type: "official", accessedAt: "2026-07-14", supports: ["identity"], notes: "หน้าข่าวทางการของกองทัพบกโคลอมเบีย ใช้อักษรย่อ AFEAU แสดงว่ารูป AFEAU ปรากฏในสิ่งพิมพ์ของกองทัพบกด้วย มิได้จำกัดอยู่เฉพาะระดับ Comando General (เนื้อหาหน้าเว็บถูกบล็อก HTTP 403 จึงยืนยันหัวเรื่องผ่านการค้นคืนของเครื่องมือค้นหา)" },
      { title: "Fuerzas Especiales Antiterroristas Urbanas (Afeur) protegen y vigilan el Urabá antioqueño", publisher: "Ejército Nacional de Colombia (ejercito.mil.co)", url: "https://www.ejercito.mil.co/fuerzas-especiales-antiterroristas-urbanas-afeur-protegen-y-vigilan-el-uraba-antioqueno/", type: "official", accessedAt: "2026-07-14", supports: ["identity"], notes: "หน้าข่าวทางการของกองทัพบกโคลอมเบีย ใช้รูปอักษรย่อ Afeur สำหรับชื่อ Fuerzas Especiales Antiterroristas Urbanas สนับสนุนข้อเท็จจริงว่ามีการใช้ทั้งสองรูปในแหล่งทางการ โดยไม่มีคำอธิบายความแตกต่างระหว่างอักษรย่อ (เนื้อหาหน้าเว็บถูกบล็อก HTTP 403 จึงยืนยันหัวเรื่องผ่านการค้นคืนของเครื่องมือค้นหา)" },
    ],
  },
  "Chile::BOE": {
    branch: "Chilean Army (Ejército de Chile)",
    unitType: "Army special operations brigade",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "Brigada de Operaciones Especiales “Lautaro” (เรียกย่อว่า BOE “Lautaro” หรือ BOE) เป็นหน่วยปฏิบัติการพิเศษของกองทัพบกชิลี (Ejército de Chile) ชื่อทางการที่กองทัพบกชิลีใช้ในหน้าข่าวและป้ายหมวดหมู่คือ Brigada de Operaciones Especiales “Lautaro” บทบาทที่แหล่งทางการอธิบายเน้นความพร้อมและการรับรองมาตรฐานปฏิบัติการพิเศษ (‘los cinco fundamentos de Operaciones Especiales’) รวมถึงการวางแผนและการปฏิบัติการพิเศษ และความพร้อมใช้กำลัง (disponibilidad de empleo) ทั้งนี้ไม่พบแหล่งทางการปฐมภูมิที่ระบุปีสถาปนาอย่างชัดเจน (แหล่งทุติยภูมิให้ปีที่ขัดแย้งกันระหว่าง 2006 กับ 2007) จึงไม่ระบุปีก่อตั้งไว้ในเรกคอร์ดนี้ และไม่รวมรายละเอียดหน่วยรอง การวางกำลัง อาวุธ หรือคำขวัญที่ไม่มีแหล่งทางการปฐมภูมิยืนยัน" },
    sources: [
      { title: "Unidades de la BOE “Lautaro” certifican los cinco fundamentos de Operaciones Especiales", publisher: "Ejército de Chile (ejercito.cl)", url: "https://www.ejercito.cl/prensa/visor/unidades-de-la-boe-lautaro-certifican-los-cinco-fundamentos-de-operaciones-especiales", type: "official", accessedAt: "2026-07-14", supports: ["identity", "role"], notes: "หน้าข่าวทางการของกองทัพบกชิลี ยืนยันชื่อ BOE “Lautaro” และแนวคิด ‘cinco fundamentos de Operaciones Especiales’ (การเข้าถึงอัตโนมัติถูกบล็อก HTTP 403 จึงยืนยันชื่อ/หัวเรื่องผ่านการค้นคืนของเครื่องมือค้นหา)" },
      { title: "Brigada de Operaciones Especiales “Lautaro” — historial de noticias", publisher: "Ejército de Chile (ejercito.cl)", url: "https://www.ejercito.cl/prensa/historial-noticias?tag=Brigada+de+Operaciones+Especiales+%E2%80%9CLautaro%E2%80%9D", type: "official", accessedAt: "2026-07-14", supports: ["identity", "branch"], notes: "หน้าดัชนีข่าวทางการตามป้ายหมวดหมู่ ยืนยันชื่อทางการ Brigada de Operaciones Especiales “Lautaro” ในฐานะหน่วยของกองทัพบกชิลี (การเข้าถึงอัตโนมัติถูกบล็อก HTTP 403 จึงยืนยันหัวเรื่องผ่านการค้นคืนของเครื่องมือค้นหา)" },
    ],
  },
  "Argentina::601": {
    founded: "No formally documented modern establishment date; a wartime 'Compañía de Comandos 601 Movilizada' was raised on 2 April 1982 during the Malvinas/Falklands conflict, but official sources do not establish institutional continuity with the present-day unit",
    branch: "Argentine Army (Ejército Argentino) — Agrupación de Fuerzas de Operaciones Especiales, Fuerza de Despliegue Rápido",
    unitType: "Army commando company",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "Compañía de Comandos 601 เป็นหน่วยคอมมานโดของกองทัพบกอาร์เจนตินา (Ejército Argentino) เอกสารทางการของรัฐบาลอาร์เจนตินาระบุว่าหน่วยนี้เป็นส่วนหนึ่งของ Agrupación de Fuerzas de Operaciones Especiales ภายใต้ Fuerza de Despliegue Rápido และปรากฏในการฝึกและการปฏิบัติในปัจจุบัน (เช่น การฝึกดำน้ำ/เทคนิคสะเทินน้ำสะเทินบก และการฝึกร่วม) ควรแยกอย่างชัดเจนระหว่างหน่วยในช่วงสงคราม ‘Compañía de Comandos 601 Movilizada’ ที่จัดตั้งขึ้นเมื่อวันที่ 2 เมษายน 1982 ในความขัดแย้งหมู่เกาะมัลบินัส/ฟอล์กแลนด์ (บังคับบัญชาโดย Mayor Mario Castagneto) กับ Compañía de Comandos 601 ในปัจจุบัน โดยแหล่งทางการที่เข้าถึงได้ไม่ได้ยืนยันความต่อเนื่องขององค์กรระหว่างสองหน่วยนี้ จึงไม่ควรนำวันจัดตั้งหน่วยช่วงสงครามปี 1982 มาใช้เป็นวันสถาปนาอย่างเป็นทางการของหน่วยปัจจุบัน ทั้งนี้ต้องแยก Compañía de Comandos 601 ออกจากหน่วยอื่นที่ใช้เลข 601 หรือหมายเลขใกล้เคียง เช่น Compañía de Fuerzas Especiales 601, Compañía de Comandos 602 และ 603 และจาก Escuadrón Alacrán ซึ่งเป็นหน่วยของ Gendarmería Nacional (คนละกำลัง) รายละเอียดกำลังพล อาวุธ และการปฏิบัติเชิงยุทธวิธีเฉพาะไม่ได้นำมารวมไว้" },
    sources: [
      { title: "El Jefe del Ejército supervisó ejercitaciones de la Fuerza de Despliegue Rápido", publisher: "Gobierno de Argentina / Ejército Argentino (argentina.gob.ar)", url: "https://www.argentina.gob.ar/noticias/el-jefe-del-ejercito-superviso-ejercitaciones-de-la-fuerza-de-despliegue-rapido", type: "government", accessedAt: "2026-07-14", supports: ["identity", "branch"], notes: "ข่าวทางการของรัฐบาลอาร์เจนตินา ระบุ Compañía de Comandos 601 อยู่ภายใต้ Agrupación de Fuerzas de Operaciones Especiales ในโครงสร้าง Fuerza de Despliegue Rápido และแยกจาก Compañía de Fuerzas Especiales 601 และ Compañía de Comandos 602" },
      { title: "Actividades de adiestramiento del Ejército", publisher: "Gobierno de Argentina / Ejército Argentino (argentina.gob.ar)", url: "https://www.argentina.gob.ar/noticias/actividades-de-adiestramiento-del-ejercito", type: "government", accessedAt: "2026-07-14", supports: ["identity", "role"], notes: "ข่าวทางการยืนยันการดำรงอยู่และการฝึกปัจจุบันของ Compañía de Comandos 601 (การฝึกดำน้ำและเทคนิคสะเทินน้ำสะเทินบก)" },
      { title: "Malvinas 44 años: las Fuerzas Especiales detrás de escena", publisher: "Gobierno de Argentina (argentina.gob.ar)", url: "https://www.argentina.gob.ar/noticias/malvinas-44-anos-las-fuerzas-especiales-detras-de-escena", type: "government", accessedAt: "2026-07-14", supports: ["history"], notes: "บทความประวัติศาสตร์ทางการ สนับสนุนเฉพาะการจัดตั้ง ‘Compañía de Comandos 601 Movilizada’ เมื่อ 2 เมษายน 1982 (Mayor Castagneto) ในสงครามมัลบินัส โดยไม่ได้ยืนยันความต่อเนื่องกับหน่วยปัจจุบัน" },
    ],
  },
  "Uruguay::CEA": {
    branch: "Uruguayan Army (Ejército Nacional) — Batallón de Infantería Paracaidista N.º 14",
    unitType: "Army counter-terrorism company",
    status: "Active",
    reviewedOn: "2026-07-14",
    history: { summary: "หน่วยที่ฐานข้อมูลนี้ติดตามภายใต้รหัส CEA มีชื่อทางการตามแหล่งข้อมูลของกองทัพบกอุรุกวัยว่า Compañía Especial Antiterrorista “Escorpión” โดยใช้อักษรย่อทางการว่า CEAT (ปรากฏในรูป C.E.A.T. ในเอกสารราชการ) มิใช่ ‘CEA’ ตามข้อมูลที่เปิดเผยต่อสาธารณะ หน่วยนี้เป็นของกองทัพบกอุรุกวัย (Ejército Nacional) และผูกกับ Batallón de Infantería Paracaidista N.º 14 บทบาทที่แหล่งทางการระบุครอบคลุมการต่อต้านการก่อการร้าย การฝึกจู่โจม (asalto) การฝึกพลซุ่มยิง (tirador) การฝึกยิงปืน การช่วยเหลือตัวประกันและการเก็บกู้/ทำลายวัตถุระเบิด รวมถึงการฝึกร่วม (ejercicio conjunto) ทั้งนี้พระราชกฤษฎีกาเลขที่ 337/015 เป็นการให้ค่าตอบแทนพิเศษและยืนยันการดำรงอยู่/สถานะทางปกครองของหน่วย มิใช่การระบุวันจัดตั้ง จึงไม่ระบุปีสถาปนาเนื่องจากไม่มีแหล่งทางการที่ระบุไว้อย่างชัดเจน รายละเอียดกำลังพลและอาวุธไม่ได้นำมารวมไว้" },
    sources: [
      { title: "28º Curso de Contraterrorismo", publisher: "Ejército Nacional del Uruguay (ejercito.mil.uy)", url: "https://www.ejercito.mil.uy/index.php/2021/09/09/28-curso-de-contraterrorismo/", type: "official", accessedAt: "2026-07-14", supports: ["identity", "branch", "role"], notes: "หน้าข่าวทางการของกองทัพบกอุรุกวัย ใช้ชื่อ Compañía Especial Antiterrorista “Escorpión” ระบุการสังกัด Ejército Nacional และความผูกพันกับ Batallón de Infantería Paracaidista N.º 14 พร้อมหลักสูตรต่อต้านการก่อการร้ายและความชำนาญ asalto/tirador" },
      { title: "Instrucción de tiro", publisher: "Ejército Nacional del Uruguay (ejercito.mil.uy)", url: "https://www.ejercito.mil.uy/index.php/2021/01/20/instruccion-de-tiro/", type: "official", accessedAt: "2026-07-14", supports: ["role"], notes: "หน้าข่าวทางการ ยืนยันชื่อหน่วยและการฝึกยิงปืนที่ดำเนินการ ณ Batallón de Infantería Paracaidista N.º 14" },
      { title: "Ejercicio conjunto", publisher: "Ejército Nacional del Uruguay (ejercito.mil.uy)", url: "https://www.ejercito.mil.uy/index.php/2024/11/15/ejercicio-conjunto/", type: "official", accessedAt: "2026-07-14", supports: ["role"], notes: "หน้าข่าวทางการ สนับสนุนบทบาทการช่วยเหลือตัวประกันและการทำลายวัตถุระเบิด และการฝึกร่วม (2024)" },
      { title: "Decreto N.º 337/015 — compensación especial (C.E.A.T.)", publisher: "Presidencia de la República Oriental del Uruguay (gub.uy)", url: "https://www.gub.uy/presidencia/institucional/normativa/decreto-337015-otorgamiento-comando-general-del-ejercito-compensacion", type: "government", accessedAt: "2026-07-14", supports: ["identity", "branch"], notes: "เอกสารราชการ ยืนยันอักษรย่อ C.E.A.T. และความผูกพันกับ Batallón de Infantería Paracaidista N.º 14 และการดำรงอยู่ของหน่วย ณ ปี 2015 (มิใช่วันจัดตั้ง)" },
    ],
  },
  "Brazil::BOPE": {
    branch: "Polícia Militar do Estado do Rio de Janeiro (PMERJ) — state-level uniformed public-security institution, not the Brazilian Armed Forces",
    unitType: "State military police special operations battalion (police intervention force / tactical reserve)",
    status: "Active",
    reviewedOn: "2026-07-15",
    history: { summary: "Batalhão de Operações Policiais Especiais (BOPE) เป็นหน่วยตำรวจของ Polícia Militar do Estado do Rio de Janeiro (PMERJ) ซึ่งเป็นสถาบันความมั่นคงสาธารณะในเครื่องแบบระดับรัฐของบราซิล มิใช่หน่วยของกองทัพบกบราซิลหรือกองทัพแห่งชาติ คำว่า ‘Polícia Militar’ ในบริบทบราซิลหมายถึงตำรวจในเครื่องแบบระดับรัฐ จึงไม่ควรตีความว่าหน่วยนี้มีสถานะเป็นหน่วยรบพิเศษของกองทัพระดับชาติ เอกสารทางการของ Secretaria de Estado de Polícia Militar do Rio de Janeiro ระบุว่า BOPE เป็น ‘força de intervenção’ ของ PMERJ ที่รับผิดชอบการปฏิบัติในสถานการณ์วิกฤต (situações críticas) และเป็น ‘reserva tática de pronto emprego’ ของหน่วยงาน ตั้งแต่ปี 2011 BOPE เป็นส่วนหนึ่งของ Comando de Operações Especiais (COE) ซึ่งเป็นหน่วยบังคับบัญชาที่ประกอบด้วย BOPE, Batalhão de Polícia de Choque (BPChq), Batalhão de Ações com Cães (BAC) และ Grupamento Aeromóvel (GAM) ดังนั้น COE กับ BOPE จึงมิใช่องค์กรเดียวกัน แต่ COE เป็นหน่วยเหนือที่ BOPE สังกัดอยู่ เอกสารทางการเดือนมกราคม 2020 ระบุว่าหน่วยครบ 42 ปี อย่างไรก็ตามไม่พบแหล่งทางการที่ระบุปีก่อตั้งของกองพันไว้อย่างชัดเจน การอ้างถึงปี 1978 ในเอกสารทางการปรากฏเฉพาะในคำกล่าวโดยตรงของผู้บังคับหน่วย และในบริบทของหลักสูตร Curso de Operações Especiais (COEsp) ซึ่งเป็นหลักสูตร มิใช่ตัวกองพัน จึงไม่ระบุปีก่อตั้งไว้ในเรกคอร์ดนี้และไม่คำนวณปีจากจำนวนปีครบรอบ ทั้งนี้ต้องแยก BOPE ของรีโอเดจาเนโรออกจากหน่วยชื่อ BOPE ของรัฐอื่นในบราซิล และไม่รวมรายละเอียดอาวุธ ยานพาหนะ กำลังพล สถิติการคัดเลือก หรือชื่อเรียกอย่างไม่เป็นทางการ" },
    sources: [
      { title: "BOPE — Batalhão de Operações Policiais Especiais", publisher: "Secretaria de Estado de Polícia Militar do Rio de Janeiro (SEPM/PMERJ)", url: "https://sepm.rj.gov.br/2015/10/bope-batalhao-de-operacoes-especiais/", type: "government", accessedAt: "2026-07-15", supports: ["identity", "branch", "role", "history"], notes: "หน้าโปรไฟล์ทางการของ SEPM/PMERJ ยืนยันชื่อเต็ม Batalhão de Operações Policiais Especiais (BOPE) การสังกัด Polícia Militar do Estado do Rio de Janeiro สถานะ ‘força de intervenção’ สำหรับสถานการณ์วิกฤตและ ‘reserva tática de pronto emprego’ ของหน่วยงาน และการเข้าเป็นส่วนหนึ่งของ Comando de Operações Especiais (COE) ในปี 2011 ร่วมกับ BPChq, BAC และ GAM (หน้านี้ไม่ปรากฏปี 1978 หรือปีก่อตั้ง ระบุเพียง ‘mais de três décadas de existência’)" },
      { title: "BOPE comemora 42 anos com coletânea de fotos exclusivas sobre a rotina e atuação da unidade especial", publisher: "Secretaria de Estado de Polícia Militar do Rio de Janeiro (SEPM)", url: "https://sepm.rj.gov.br/2020/01/bope-comemora-42-anos-com-coletanea-de-fotos-exclusivas-sobre-a-rotina-e-atuacao-da-unidade-especial/", type: "government", accessedAt: "2026-07-15", supports: ["identity", "branch", "history"], notes: "หน้าข่าวทางการ (มกราคม 2020) ยืนยันชื่อเต็มของหน่วยและการสังกัด Secretaria de Estado de Polícia Militar do Rio de Janeiro พร้อมระบุว่าหน่วยครบ 42 ปี ณ เวลานั้น โดยข้อความของสถาบันไม่ได้ระบุปีก่อตั้ง (ปี 1978 ปรากฏเฉพาะในคำกล่าวอ้างโดยตรงของผู้บังคับหน่วย จึงไม่ใช้เป็นปีก่อตั้ง)" },
    ],
  },
  "Peru::CEV": {
    branch: "Comando Conjunto de las Fuerzas Armadas del Perú (CCFFAA) — joint operational command; operations involve the Armed Forces together with the Policía Nacional del Perú",
    unitType: "Joint operational command (not a single special-forces unit)",
    status: "Active",
    reviewedOn: "2026-07-15",
    history: { summary: "Comando Especial VRAEM ซึ่งใช้อักษรย่อทางการว่า CE-VRAEM เป็นโครงสร้างบังคับบัญชาร่วมเชิงปฏิบัติการ (joint operational command) ในพื้นที่ Valle de los Ríos Apurímac, Ene y Mantaro (VRAEM) ของเปรู มิใช่หน่วยรบพิเศษหน่วยเดียว ตามข้อมูลที่เปิดเผยต่อสาธารณะ หน่วยบังคับบัญชานี้อยู่ภายใต้ Comando Conjunto de las Fuerzas Armadas (CCFFAA) โดยผู้บัญชาการ CE-VRAEM ได้รับการรับรองจากหัวหน้า CCFFAA และมีที่ตั้งกองบัญชาการที่ Base Militar de Pichari จังหวัด La Convención เขต Cusco เอกสารทางการระบุว่า CE-VRAEM ประกอบด้วยองค์ประกอบหลายส่วน เช่น Componente Terrestre, Componente Aéreo, Componente Naval และ Componente de Fuerzas Especiales ดังนั้นการที่องค์ประกอบกำลังรบพิเศษเข้าร่วมปฏิบัติการจึงมิได้ทำให้ CE-VRAEM เป็นหน่วยรบพิเศษในตัวเอง เอกสารของกระทรวงกลาโหมระบุว่าการปฏิบัติประกอบด้วยสมาชิกของกองทัพ (Fuerzas Armadas) และตำรวจแห่งชาติเปรู (Policía Nacional del Perú) บทบาทที่แหล่งทางการระบุครอบคลุมการต่อต้านการค้ายาเสพติดและ ‘narcoterrorismo’ การมุ่งทำลายองค์กรก่อการร้าย และการปฏิบัติการร่วมระหว่างทหารกับตำรวจในพื้นที่ VRAEM ทั้งนี้ไม่ควรแปลงข่าวปฏิบัติการรายครั้งเป็นพันธกิจถาวรทั้งหมดของหน่วย และไม่ระบุว่าองค์ประกอบใดขึ้นสังกัดถาวรเว้นแต่มีเอกสารเชิงโครงสร้างทางการยืนยัน อนึ่ง ‘CEV’ มิใช่อักษรย่อทางการที่ปรากฏในแหล่งทางการ ฐานข้อมูลนี้จึงคง key และ slug เดิมไว้เพื่อความเสถียรของเส้นทาง พร้อมแสดงอักษรย่อทางการ CE-VRAEM ในชื่อสาธารณะ สำหรับปีจัดตั้ง ไม่พบกฤษฎีกา คำสั่ง หรือเอกสารโครงสร้างทางการที่ตรวจสอบตัวบทได้ซึ่งระบุปีจัดตั้งไว้โดยตรง จึงไม่ระบุปีก่อตั้งไว้ในเรกคอร์ดนี้" },
    sources: [
      { title: "Comandante del CE-VRAEM fue reconocido por el Jefe del CCFFAA", publisher: "Comando Conjunto de las Fuerzas Armadas del Perú (gob.pe)", url: "https://www.gob.pe/institucion/ccffaa/noticias/563408-comandante-del-ce-vraem-fue-reconocido-por-el-jefe-del-ccffaa", type: "official", accessedAt: "2026-07-15", supports: ["identity", "branch"], notes: "ข่าวทางการของ CCFFAA ระบุชื่อเต็ม Comando Especial del Valle de los ríos Apurímac, Ene y Mantaro (CE-VRAEM) การที่หัวหน้า CCFFAA เป็นผู้รับรองผู้บัญชาการของหน่วยบังคับบัญชานี้ ที่ตั้งกองบัญชาการ Base Militar de Pichari และการมีฐานและหน่วยองค์ประกอบในสังกัด (สนับสนุนลักษณะการเป็นหน่วยบังคับบัญชา มิใช่หน่วยเดียว)" },
      { title: "Componente Naval del Comando Especial VRAEM ejecutó entrenamiento conjunto evidenciando sus capacidades operativas", publisher: "Marina de Guerra del Perú (gob.pe)", url: "https://www.gob.pe/institucion/marina/noticias/1023042-componente-naval-del-comando-especial-vraem-ejecuto-entrenamiento-conjunto-evidenciando-sus-capacidades-operativas", type: "official", accessedAt: "2026-07-15", supports: ["identity", "branch", "role"], notes: "ข่าวทางการของกองทัพเรือเปรู ระบุ Componente Aéreo, Componente de Fuerzas Especiales และ Componente Terrestre ในฐานะองค์ประกอบ ‘del CE-VRAEM’ และระบุ Componente Naval ว่า ‘integra el Comando Especial VRAEM’ สนับสนุนลักษณะการเป็นหน่วยบังคับบัญชาร่วมหลายองค์ประกอบ รวมถึงการขยายชื่อ VRAEM และวัตถุประสงค์ต่อต้านองค์กรก่อการร้ายและการค้ายาเสพติด" },
      { title: "Comando Especial VRAEM golpea al narcoterrorismo: desmantela laboratorio con cinco toneladas de hoja de coca en Junín", publisher: "Ministerio de Defensa del Perú (gob.pe)", url: "https://www.gob.pe/institucion/mindef/noticias/1412515-comando-especial-vraem-golpea-al-narcoterrorismo-desmantela-laboratorio-con-cinco-toneladas-de-hoja-de-coca-en-junin", type: "official", accessedAt: "2026-07-15", supports: ["identity", "role"], notes: "ข่าวทางการของกระทรวงกลาโหมเปรู ใช้ชื่อและอักษรย่อ Comando Especial VRAEM (CE-VRAEM) และระบุว่าหน่วยบังคับบัญชานี้ ‘integrado por miembros de las Fuerzas Armadas y la Policía Nacional del Perú’ พร้อมบทบาทต่อต้านการค้ายาเสพติด/narcoterrorismo (ใช้สนับสนุนองค์ประกอบและบทบาทกว้าง มิใช่พันธกิจถาวรทั้งหมด)" },
    ],
  },
  "Ecuador::GOE": {
    founded: "Current 'Grupo de Operaciones Especiales' designation adopted on 11 March 1992; the organization traces its origin to 1982 within the Policía Nacional del Ecuador and was previously known as Grupo de Reacción",
    branch: "Policía Nacional del Ecuador — national police, not the Ecuadorian Armed Forces",
    unitType: "Police special operations / tactical unit",
    status: "Active",
    reviewedOn: "2026-07-15",
    history: { summary: "Grupo de Operaciones Especiales (GOE) เป็นหน่วยปฏิบัติการพิเศษ/ยุทธวิธีของ Policía Nacional del Ecuador (ตำรวจแห่งชาติเอกวาดอร์) มิใช่หน่วยของกองทัพเอกวาดอร์ เอกสารทางการของกระทรวงมหาดไทย (Ministerio de Gobierno) ระบุประวัติของหน่วยว่ามีจุดกำเนิดในปี 1982 ภายในตำรวจแห่งชาติ และใช้ชื่อ Grupo de Reacción ก่อนที่จะเปลี่ยนชื่อเป็น Grupo de Operaciones Especiales เมื่อวันที่ 11 มีนาคม 1992 ดังนั้นจึงไม่ควรระบุว่าองค์กรภายใต้ชื่อ GOE ในปัจจุบันถูกก่อตั้งขึ้นในปี 1982 โดยไม่อธิบายการเปลี่ยนชื่อในปี 1992 และไม่ควรอนุมานความต่อเนื่องขององค์กรเกินกว่าถ้อยคำที่แหล่งทางการระบุไว้ เอกสารทางการของตำรวจแห่งชาติระบุว่า GOE เป็นหน่วยชั้นยอดของตำรวจแห่งชาติที่มีความเชี่ยวชาญด้านการปฏิบัติการความเสี่ยงสูง เช่น การช่วยเหลือตัวประกัน การปฏิบัติต่ออาชญากรรมที่จัดตั้ง การก่อการร้าย และยาเสพติด และทำหน้าที่สนับสนุนหน่วยตำรวจอื่น รวมถึงการเข้าตรวจค้นทางยุทธวิธี (incursión) ในเคหสถาน อาคาร และสิ่งปลูกสร้าง สำหรับโครงสร้างเชิงพื้นที่ เอกสารทางการอ้างถึง GOE ทั้งในบริบทระดับชาติ ระดับเขต (เช่น GOE Zona 8) และระดับจังหวัด (เช่น GOE del Azuay หรือ GOE de esta provincia) แต่แหล่งข้อมูลสาธารณะที่ตรวจสอบแล้วยังไม่ได้อธิบายอย่างครบถ้วนว่าการอ้างถึงเหล่านี้เป็นลำดับชั้นของหน่วยระดับชาติหน่วยเดียว หรือเป็นหน่วยเชิงพื้นที่ที่แยกจากกัน จึงไม่สรุปประเด็นนี้ไว้ในเรกคอร์ดนี้ ทั้งนี้ต้องแยก GOE ออกจากหน่วยอื่นของตำรวจแห่งชาติเอกวาดอร์ ได้แก่ GIR (Grupo de Intervención y Rescate) และ GEMA (Grupo Especial Móvil Antinarcóticos) ซึ่งเป็นคนละหน่วย และไม่นำรายการหัวข้อหลักสูตร อุปกรณ์จากบทความการฝึก หรือจำนวนกำลังพลมารวมไว้" },
    sources: [
      { title: "GOE realiza trabajo de alto riesgo en el Azuay", publisher: "Ministerio de Gobierno del Ecuador (ministeriodegobierno.gob.ec)", url: "https://www.ministeriodegobierno.gob.ec/goe-realiza-trabajo-de-alto-riesgo-en-el-azuay/", type: "government", accessedAt: "2026-07-15", supports: ["identity", "history"], notes: "หน้าข่าวทางการของกระทรวงมหาดไทยเอกวาดอร์ สนับสนุนประวัติของหน่วยตามถ้อยคำทางการ ได้แก่ จุดกำเนิดในปี 1982 การใช้ชื่อ Grupo de Reacción และการเปลี่ยนชื่อเป็น Grupo de Operaciones Especiales เมื่อวันที่ 11 มีนาคม 1992 รวมถึงการอ้างถึงหน่วยในบริบทระดับจังหวัด (GOE del Azuay) — ใช้สนับสนุนเฉพาะข้อเท็จจริงเหล่านี้ ไม่ใช้สนับสนุนจำนวนกำลังพลหรืออุปกรณ์ (โดเมนของกระทรวงปฏิเสธการเชื่อมต่ออัตโนมัติจากสภาพแวดล้อมนี้และไม่มีสำเนาที่จัดเก็บถาวร จึงไม่สามารถดึงตัวบทมายืนยันคำต่อคำได้ในรอบนี้)" },
      { title: "22 nuevos comandos se unen al GOE tras riguroso entrenamiento de operaciones especiales", publisher: "Policía Nacional del Ecuador (noticias.policia.gob.ec)", url: "https://noticias.policia.gob.ec/22-nuevos-comandos-se-unen-al-goe-tras-riguroso-entrenamiento-de-operaciones-especiales/", type: "official", accessedAt: "2026-07-15", supports: ["identity", "branch", "role"], notes: "ข่าวทางการของตำรวจแห่งชาติเอกวาดอร์ ระบุว่า ‘El Grupo de Operaciones Especiales (GOE) es una unidad élite de la Policía Nacional del Ecuador’ พร้อมความเชี่ยวชาญด้านการปฏิบัติการความเสี่ยงสูง (การช่วยตัวประกัน อาชญากรรมที่จัดตั้ง การก่อการร้าย ยาเสพติด) — ไม่ใช้สนับสนุนจำนวนกำลังพลหรืออุปกรณ์" },
      { title: "Grupo de Operaciones Especiales celebra sus 33 años de creación con una sesión solemne en Guayaquil", publisher: "Policía Nacional del Ecuador (noticias.policia.gob.ec)", url: "https://noticias.policia.gob.ec/grupo-de-operaciones-especiales-celebra-sus-33-anos-de-creacion-con-una-sesion-solemne-en-guayaquil/", type: "official", accessedAt: "2026-07-15", supports: ["identity", "branch", "role"], notes: "ข่าวทางการของตำรวจแห่งชาติเอกวาดอร์ ยืนยันชื่อเต็มและการสังกัด Policía Nacional del Ecuador และบทบาทสนับสนุนการเข้าตรวจค้นของตำรวจ ทั้งนี้บทความระบุเพียงจำนวนปีครบรอบ (33 ปี) และไม่ได้ระบุวันหรือปีจัดตั้งไว้โดยตรง จึงไม่ใช้สนับสนุนปีก่อตั้ง" },
      { title: "Incursión, una de las especialidades de los comandos del GOE", publisher: "Ministerio de Gobierno del Ecuador (ministeriodegobierno.gob.ec)", url: "https://www.ministeriodegobierno.gob.ec/incursion-una-de-las-especialidades-de-los-comandos-del-goe/", type: "government", accessedAt: "2026-07-15", supports: ["role"], notes: "หน้าข่าวทางการของกระทรวงมหาดไทยเอกวาดอร์ สนับสนุนเฉพาะบทบาทการเข้าตรวจค้นทางยุทธวิธี ‘la incursión táctica para allanamientos en domicilios, edificios y demás estructuras’ (บทความเป็นการเยี่ยมชมการฝึก จึงไม่ใช้สนับสนุนอุปกรณ์ กำลังพล หรือวันที่)" },
    ],
  },
  "Paraguay::CODI": {
    founded: "Created via Decreto N.º 103/13 (24 August 2013) according to the Paraguayan Ministry of National Defence strategic plan; the decree text itself orders the employment of Armed Forces combat elements in internal-defence operations and designates a Comandante de Operaciones de Defensa Interna, without establishing a named standing command in its wording",
    branch: "Fuerzas Armadas de la Nación (Paraguay) — internal-defence operational command",
    unitType: "Internal-defence operational command (not a special-forces unit)",
    status: "Active",
    reviewedOn: "2026-07-15",
    history: { summary: "Comando de Operaciones de Defensa Interna (CODI) เป็นหน่วยบังคับบัญชาเชิงปฏิบัติการด้านการป้องกันภายในของปารากวัย มิใช่หน่วยรบพิเศษหน่วยเดียว แผนยุทธศาสตร์ทางการของกระทรวงกลาโหมปารากวัย (Plan Seguridad para el Desarrollo 2023–2028) ระบุว่า ‘El Comando de Operaciones de Defensa Interna (CODI) fue creado mediante el Decreto N° 103/13’ เพื่อตอบสนองต่อปัญหาความไม่มั่นคงในภาคเหนือของประเทศ อย่างไรก็ตามเมื่อตรวจสอบตัวบทกฤษฎีกาเอง (ลงวันที่ 24 สิงหาคม 2013) พบว่ากฤษฎีกาสั่งการให้ใช้กำลังหน่วยรบของกองทัพ (elementos de combate de las Fuerzas Armadas de la Nación) ในปฏิบัติการป้องกันภายในในเขต Concepción, San Pedro และ Amambay กำหนดผู้บังคับบัญชาในตำแหน่ง ‘Comandante de Operaciones de Defensa Interna’ และกำหนดให้เจ้าหน้าที่ของ Policía Nacional และ SENAD ที่วางกำลังในเขตดังกล่าวอยู่ภายใต้การควบคุมทางปฏิบัติการ (Control Operacional) ของผู้บังคับบัญชานั้น โดยตัวบทกฤษฎีกามิได้ใช้คำว่า ‘Comando’ หรือ ‘CODI’ และมิได้ระบุการจัดตั้งหน่วยบังคับบัญชาถาวรในชื่อดังกล่าวไว้โดยตรง การระบุว่า CODI ‘ถูกจัดตั้งขึ้น’ โดยกฤษฎีกาฉบับนี้จึงเป็นการอธิบายย้อนหลังของกระทรวงกลาโหมเอง และไม่ควรอนุมานว่าโครงสร้างปัจจุบันทุกส่วนถูกสร้างขึ้นโดยกฤษฎีกาฉบับนี้ บทบาทที่แหล่งทางการรองรับคือการปฏิบัติการป้องกันภายในต่อกลุ่มอาชญากรรม/ก่อการร้าย และการประสานงานระหว่างหน่วยงาน ทั้งนี้ต้องแยก CODI ออกจาก Fuerza de Tarea Conjunta (FTC), Batallón de Inteligencia Militar (BIMI), Policía Nacional และ SENAD ซึ่งเป็นองค์กรคนละส่วนที่ร่วมปฏิบัติการ และไม่ควรเรียก CODI เองว่าเป็น ‘Fuerzas Especiales’ โดยหน่วยกำลังรบพิเศษของปารากวัยคือ Batallón Conjunto de Fuerzas Especiales ซึ่งเป็นคนละหน่วย ทั้งนี้ไม่รวมรายชื่อผู้บังคับบัญชาปัจจุบัน โครงสร้างหน่วยรอง กำลังพล หรืออุปกรณ์" },
    sources: [
      { title: "Plan Estratégico “Seguridad para el Desarrollo” 2023–2028", publisher: "Ministerio de Defensa Nacional del Paraguay (mdn.gov.py)", url: "https://mdn.gov.py/wp-content/uploads/2024/11/Plan-Seguridad-para-el-Desarrollo-2023-2028.pdf", type: "official", accessedAt: "2026-07-15", supports: ["identity", "history", "role"], notes: "แผนยุทธศาสตร์ทางการของกระทรวงกลาโหมปารากวัย ระบุชื่อเต็มและอักษรย่อ CODI ระบุว่า CODI ถูกจัดตั้งขึ้นโดย Decreto N° 103/13 และอธิบายบทบาทการกดดันกลุ่ม EPP รวมถึงระบุ FTC และ BIMI ไว้แยกจาก CODI (ไฟล์ PDF ทางการ; โดเมนรัฐบาลปารากวัยไม่สามารถเข้าถึงอัตโนมัติได้จากสภาพแวดล้อมนี้ จึงตรวจสอบเนื้อหาผ่านสำเนาที่จัดเก็บถาวร)" },
      { title: "Decreto N.º 103/13 — por el cual se dispone el empleo de elementos de combate de las Fuerzas Armadas de la Nación en operaciones de defensa interna", publisher: "Fuerzas Armadas de la Nación / Comando de las FFMM (ffmm.mil.py)", url: "https://ffmm.mil.py/wp-content/uploads/2025/06/DECRETO_No_10313_POR_EL_CUAL_SE_DISPONE_EL_EMPLEO_DE_ELEMENTOS_DE_COMBATE_DE_LAS_FFAA_EN_OPERACIONES_DE_DEFENSA_INTERNA_EN_LOS-1.pdf", type: "official", accessedAt: "2026-07-15", supports: ["history"], notes: "ตัวบทกฤษฎีกาทางการ (24 สิงหาคม 2013) สนับสนุนเนื้อหาที่กฤษฎีกาสั่งการจริง ได้แก่ การใช้กำลังหน่วยรบของกองทัพในปฏิบัติการป้องกันภายในในเขต Concepción, San Pedro และ Amambay การกำหนดตำแหน่ง Comandante de Operaciones de Defensa Interna และการให้เจ้าหน้าที่ Policía Nacional และ SENAD ที่วางกำลังในเขตดังกล่าวอยู่ภายใต้ Control Operacional โดยตัวบทไม่ปรากฏคำว่า ‘Comando’ หรือ ‘CODI’ (ไฟล์ PDF ทางการ; ตรวจสอบเนื้อหาผ่านสำเนาที่จัดเก็บถาวรเนื่องจากโดเมนเข้าถึงอัตโนมัติไม่ได้)" },
      { title: "Exitoso operativo del Comando de Operaciones de Defensa Interna (CODI)", publisher: "Ejército Paraguayo (ejercito.mil.py)", url: "https://ejercito.mil.py/exitoso-operativo-del-comando-de-operaciones-de-defensa-interna-codi/", type: "official", accessedAt: "2026-07-15", supports: ["identity", "branch"], notes: "ข่าวทางการของกองทัพบกปารากวัย ระบุการปฏิบัติการร่วม ‘de las Fuerzas Armadas de la Nación a través del CODI’ และระบุ CODI, Fuerza de Tarea Conjunta (FTC), Batallón de Inteligencia Militar, กรมต่อต้านการลักพาตัวของ Policía Nacional และ Ministerio Público เป็นผู้ร่วมปฏิบัติการที่แยกจากกัน (หน้านี้ไม่ปรากฏถ้อยคำ ‘Fuerzas Especiales’ จึงไม่ใช้สนับสนุนข้ออ้างดังกล่าว; ตรวจสอบเนื้อหาผ่านสำเนาที่จัดเก็บถาวร)" },
    ],
  },
  "Venezuela::BAE": {
    branch: "Cuerpo de Investigaciones Científicas, Penales y Criminalísticas (CICPC) — criminal-investigation police under the Ministerio del Poder Popular para Relaciones Interiores, Justicia y Paz (MPPRIJP); not the Venezuelan Armed Forces",
    unitType: "Criminal-investigation police tactical support unit",
    status: "Active",
    reviewedOn: "2026-07-15",
    history: { summary: "หน่วยที่ฐานข้อมูลนี้ติดตามภายใต้รหัส BAE เป็นองค์กรของ Cuerpo de Investigaciones Científicas, Penales y Criminalísticas (CICPC) ซึ่งเป็นตำรวจสืบสวนคดีอาญาภายใต้กระทรวง Ministerio del Poder Popular para Relaciones Interiores, Justicia y Paz (MPPRIJP) มิใช่หน่วยของกองทัพเวเนซุเอลา ประเด็นชื่อควรอธิบายอย่างระมัดระวัง กล่าวคือแหล่งข้อมูลทางการใช้ชื่อทั้งรูป Unidad de Apoyo a la Investigación (BAE) ซึ่งปรากฏในบทความครบรอบปัจจุบันของ MPPRIJP และในหน้าเว็บของ CICPC และรูป Unidad Especial de Apoyo a la Investigación (BAE) ซึ่งปรากฏในหน้าเว็บทางการของ CICPC เช่นกัน โดยรูปขยายนี้ตรงกับชื่อที่ใช้ใน Decreto N.º 9.045 (Gaceta Oficial N.º 6.079 Extraordinario, 2012) ทั้งนี้แหล่งข้อมูลสาธารณะที่ตรวจสอบแล้วยังไม่ได้อธิบายความสัมพันธ์ที่แน่ชัดระหว่างรูปย่อกับรูปขยายของชื่อ จึงไม่สรุปว่ารูปใดเป็นชื่อทางการเพียงรูปเดียว หรือทั้งสองรูปแบ่งแยกตามบริบทการใช้งานอย่างไร นอกจากนี้ยังมีชื่อทางประวัติศาสตร์เมื่อแรกก่อตั้งคือ Brigada de Acciones Especiales (BAE) โดยบทความของ MPPRIJP อธิบายหน่วยปัจจุบันว่า ‘históricamente conocida como la Brigada de Acciones Especiales (BAE)’ และระบุว่าหน่วยก่อตั้งในปี 1980 (‘desde su fundación en el año 1980’) ในชื่อ Brigada de Acciones Especiales แล้วพัฒนามาเป็นองค์กรสนับสนุนการสืบสวนในปัจจุบัน ขณะที่บทเฉพาะกาลของ Decreto N.º 9.045 ระบุการยกเลิก Brigada de Acciones Especiales และการจัดตั้ง Unidad Especial de Apoyo a la Investigación ขึ้น ด้วยเหตุนี้ ปี 1980 จึงบันทึกไว้เป็นจุดกำเนิดทางประวัติศาสตร์ของ Brigada เดิมตามที่แหล่งทางการระบุ มิใช่วันสถาปนาของหน่วยสนับสนุนการสืบสวนในปัจจุบันโดยอัตโนมัติ จึงไม่ระบุปีก่อตั้งไว้ในเรกคอร์ดนี้ และไม่ระบุความต่อเนื่องของบทบาท โครงสร้าง หรือภารกิจแบบไม่ขาดตอนตั้งแต่ปี 1980 ถึงปัจจุบัน บทบาทตามกฎหมาย (มาตรา 59) จำกัดไว้เฉพาะการสนับสนุนเจ้าหน้าที่สืบสวนของ CICPC เช่น การเข้าถึงและเปิดพื้นที่ การคุ้มครองความปลอดภัยของเจ้าหน้าที่และผู้ช่วยในระบบยุติธรรมทางอาญา การจับกุมบุคคลตามหมายศาล การคุ้มครองผู้เสียหายหรือบุคคลที่มีความเสี่ยงสูง และการรักษาร่องรอยและพยานหลักฐาน โดยห้ามปฏิบัติภารกิจนอกเหนือจากที่กำหนดไว้ ขณะที่เอกสารข่าวของ MPPRIJP บรรยายหน่วยในเชิงสถาบันว่าเป็น ‘fuerza de choque y apoyo táctico’ ของ CICPC ที่เข้าปฏิบัติในสถานการณ์อันตรายสูง จึงบันทึกทั้งสองส่วนไว้ตามที่แหล่งทางการระบุ โดยไม่ประสานให้เป็นข้อความเดียว ทั้งนี้ต้องแยก BAE ออกจาก FAES หน่วยยุทธวิธีของ Policía Nacional Bolivariana หน่วยรบพิเศษของกองทัพเวเนซุเอลา และองค์กรอื่นที่ใช้อักษรย่อ BAE" },
    sources: [
      { title: "CICPC conmemoró el 46° aniversario de la Unidad de Apoyo a la Investigación (BAE)", publisher: "Ministerio del Poder Popular para Relaciones Interiores, Justicia y Paz (mpprijp.gob.ve)", url: "https://www.mpprijp.gob.ve/prensa/reporte/cicpc-conmemoro-el-46-aniversario-de-la-unidad-de-apoyo-a-la-investigacion-bae", type: "government", accessedAt: "2026-07-15", supports: ["identity", "branch", "history", "role"], notes: "บทความทางการของกระทรวง MPPRIJP สนับสนุนชื่อปัจจุบัน Unidad de Apoyo a la Investigación (BAE) การอธิบายว่า ‘históricamente conocida como la Brigada de Acciones Especiales (BAE)’ การระบุปีก่อตั้ง 1980 ของ Brigada de Acciones Especiales โดยตรงในตัวบท การสังกัด CICPC และการบรรยายเชิงสถาบันว่าเป็น ‘fuerza de choque y apoyo táctico del Cicpc’ (การเข้าถึงอัตโนมัติถูกบล็อก HTTP 403 จึงตรวจสอบเนื้อหาผ่านสำเนาที่จัดเก็บถาวร)" },
      { title: "Decreto N.º 9.045 — Ley Orgánica del Servicio de la Policía de Investigación, el CICPC y el INMCF (Gaceta Oficial N.º 6.079 Extraordinario, 2012)", publisher: "Asamblea Nacional de la República Bolivariana de Venezuela (asambleanacional.gob.ve)", url: "https://www.asambleanacional.gob.ve/leyes/sancionadas/decreto-n0-9045-mediante-el-cual-se-dicta-el-decreto-con-rango-valor-y-fuerza-de-ley-organica-del-servicio-de-la-policia-de-investigacion-el-cuerpo-de-investigaciones-cientificas-penales-y-criminalisticas-y-el-instituto-nacional-de-medicina-y-ciencia", type: "official", accessedAt: "2026-07-15", supports: ["identity", "branch", "role", "history"], notes: "กฎหมายปฐมภูมิของเวเนซุเอลา สนับสนุนชื่อตามกฎหมาย ‘Unidad Especial de Apoyo a la Investigación’ ขอบเขตภารกิจสนับสนุนการสืบสวนตามมาตรา 58–59 ข้อห้ามปฏิบัติภารกิจนอกเหนือที่กำหนด และบทเฉพาะกาลที่ยกเลิก Brigada de Acciones Especiales พร้อมจัดตั้งหน่วยตามกฎหมายขึ้นแทน รวมถึงการที่กระทรวงด้านความมั่นคงพลเมืองเป็นองค์กรกำกับ (ตัวไฟล์ทางการเป็นภาพสแกนไม่มีชั้นข้อความ จึงตรวจสอบถ้อยคำมาตราผ่านสำเนาตัวบทที่ตรงกันหลายแหล่ง โดยอ้างอิงตัวกฤษฎีกา/Gaceta เป็นแหล่ง)" },
      { title: "Unidad de Apoyo a la Investigación — BAE", publisher: "Cuerpo de Investigaciones Científicas, Penales y Criminalísticas (cicpc.gob.ve)", url: "https://www.cicpc.gob.ve/index.php/bae/", type: "official", accessedAt: "2026-07-15", supports: ["identity"], notes: "หน้าทางการของ CICPC ใช้ชื่อ ‘UNIDAD DE APOYO A LA INVESTIGACIÓN - BAE’ สนับสนุนการที่ CICPC ใช้ชื่อรูปย่อคู่กับอักษรย่อ BAE (โฮสต์ปฏิเสธการเชื่อมต่ออัตโนมัติ ECONNREFUSED จึงตรวจสอบชื่อผ่านสำเนาที่จัดเก็บถาวร; เนื้อหาส่วนรายละเอียดถูก CICPC จำกัดการเผยแพร่)" },
      { title: "CICPC — publicación institucional que emplea la forma “Unidad Especial de Apoyo a la Investigación (BAE)”", publisher: "Cuerpo de Investigaciones Científicas, Penales y Criminalísticas (cicpc.gob.ve)", url: "https://www.cicpc.gob.ve/?p=8841", type: "official", accessedAt: "2026-07-15", supports: ["identity"], notes: "หน้าทางการของ CICPC ที่ใช้รูปชื่อ ‘Unidad Especial de Apoyo a la Investigación (BAE)’ ใช้สนับสนุนเฉพาะรูปแบบการเรียกชื่อทางการเท่านั้น มิใช่ภารกิจ ประวัติ หรือความต่อเนื่องขององค์กร เนื่องจากเนื้อหาหลักของหน้าเป็นงานครบรอบของ CICPC (โฮสต์ cicpc.gob.ve ปฏิเสธการเชื่อมต่ออัตโนมัติจากสภาพแวดล้อมนี้และไม่มีสำเนาที่จัดเก็บถาวร จึงไม่สามารถดึงตัวบทมายืนยันคำต่อคำได้ในรอบนี้)" },
    ],
  },
  "Australia::2 CDO": {
    branch: "Australian Army — Special Operations Command (SOCOMD), Special Forces Group",
    unitType: "Army commando regiment (special operations)",
    status: "Active",
    reviewedOn: "2026-07-26",
    history: { summary: "2nd Commando Regiment (2 Cdo Regt) เป็นหน่วยรบพิเศษของกองทัพบกออสเตรเลีย ขึ้นตรงต่อ Special Operations Command (SOCOMD) โดยจัดอยู่ภายใต้ Special Forces Group ซึ่งเป็นกองบังคับการระดับกองพลน้อยที่กำกับดูแลหน่วยรบพิเศษของ SOCOMD ร่วมกับ 1st Commando Regiment และ Special Air Service Regiment หน่วยมีที่ตั้งหลักที่ Holsworthy Barracks นครซิดนีย์ รัฐนิวเซาท์เวลส์ บทบาทที่เปิดเผยต่อสาธารณะคือการปฏิบัติการคอมมานโดและปฏิบัติการพิเศษของกองทัพบก โดยแนวปฏิบัติที่เอกสารทางการของกระทรวงกลาโหมออสเตรเลียระบุไว้คือ หน่วยในสังกัด SOCOMD โดยทั่วไปจะไม่ถูกส่งไปปฏิบัติภารกิจหรือการฝึกขนาดใหญ่ทั้งหน่วย แต่จะจัดกำลังพลจากหลายหน่วยมารวมกันเป็นกำลังเฉพาะกิจที่เรียกว่า Special Operations Task Force (SOTF) ทั้งนี้ปีจัดตั้งของกรมและรายละเอียดสายเชื้อสายจากหน่วยเดิมยังไม่ได้รับการยืนยันจากแหล่งทางการภายในรอบการตรวจสอบนี้ จึงไม่ระบุไว้ในเรกคอร์ด และรายละเอียดกำลังพล อาวุธ และวิธีปฏิบัติของหน่วยไม่ได้เปิดเผยต่อสาธารณะ" },
    sources: [
      { title: "Special Operations Command", publisher: "Australian Army (army.gov.au)", url: "https://www.army.gov.au/about-us/leadership/special-operations-command", type: "official", accessedAt: "2026-07-26", supports: ["identity", "branch", "role"], notes: "หน้าทางการของกองทัพบกออสเตรเลีย สนับสนุนตัวตนของ 2nd Commando Regiment การขึ้นตรงต่อ Special Operations Command ผ่าน Special Forces Group และที่ตั้งในนครซิดนีย์ (โดเมน army.gov.au ไม่ตอบสนองต่อการดึงข้อมูลอัตโนมัติจากสภาพแวดล้อมนี้ จึงตรวจสอบเนื้อหาผ่านการค้นคืนที่จำกัดเฉพาะโดเมนทางการ)" },
      { title: "Special Operations Command — Fact Sheet", publisher: "Department of Defence (Australia)", url: "https://www.defence.gov.au/sites/default/files/2021-07/special_operations_command.pdf", type: "official", accessedAt: "2026-07-26", supports: ["branch", "role"], notes: "เอกสารข้อเท็จจริงทางการของกระทรวงกลาโหมออสเตรเลีย สนับสนุนโครงสร้าง SOCOMD ที่ประกอบด้วย 1st Commando Regiment, 2nd Commando Regiment และ Special Air Service Regiment ที่ตั้ง Holsworthy Barracks และแนวปฏิบัติการจัดกำลังเป็น Special Operations Task Force (ไฟล์ PDF ทางการ; ไม่สามารถดึงข้อมูลอัตโนมัติได้ จึงตรวจสอบเนื้อหาผ่านการค้นคืนที่จำกัดเฉพาะโดเมนทางการ)" },
    ],
  },
  "Solomon Islands::PRT": {
    branch: "Royal Solomon Islands Police Force (RSIPF) — National Response Department (NRD)",
    unitType: "Police specialist response / public order management team (not a military special forces unit)",
    status: "Active",
    reviewedOn: "2026-07-26",
    history: { summary: "Police Response Team (PRT) เป็นหน่วยตอบสนองเฉพาะทางของ Royal Solomon Islands Police Force (RSIPF) มิใช่หน่วยรบพิเศษของกองทัพ เนื่องจากหมู่เกาะโซโลมอนไม่มีกองทัพประจำการ หน่วยอยู่ในสังกัด National Response Department (NRD) ของ RSIPF ซึ่งกำกับดูแลขีดความสามารถเฉพาะทางอื่นด้วย เช่น Close Personal Protection (CPP), Explosive Ordnance Disposal (EOD) และงาน Fire and Rescue บทบาทที่แหล่งทางการของ RSIPF ระบุไว้เน้นการจัดการความสงบเรียบร้อยของประชาชน (Public Order Management) และการตอบสนองต่อเหตุการณ์ที่ต้องใช้กำลังพลที่ผ่านการฝึกเฉพาะทาง โดย RSIPF เผยแพร่การฝึกร่วมระหว่าง PRT กับ Central Response Unit (CRU) และ Guadalcanal Police Response Unit (GPRU) รวมถึงการรับการสนับสนุนด้านอุปกรณ์และการฝึกจาก Australian Federal Police ภายใต้ RSIPF-AFP Policing Partnership Program (RAPPP) ทั้งนี้ปีจัดตั้งของหน่วย โครงสร้างภายใน และกำลังพลยังไม่มีแหล่งทางการที่ตรวจสอบได้ในรอบนี้ จึงไม่ระบุไว้" },
    sources: [
      { title: "RSIPF boost officers in specialist units", publisher: "Royal Solomon Islands Police Force (rsipf.gov.sb)", url: "https://www.rsipf.gov.sb/?q=node/1664", type: "official", accessedAt: "2026-07-26", supports: ["identity", "branch", "role"], notes: "ข่าวทางการของ RSIPF ยืนยันตัวตนของ Police Response Team การอยู่ในสังกัด National Response Department และการจัดหน่วยเฉพาะทางอื่นภายใต้ NRD (CPP, EOD, OST, Fire and Rescue)" },
      { title: "Police Response Team conducts public order management training", publisher: "Royal Solomon Islands Police Force (rsipf.gov.sb)", url: "https://www.rsipf.gov.sb/?q=node/483", type: "official", accessedAt: "2026-07-26", supports: ["role"], notes: "ข่าวทางการของ RSIPF สนับสนุนบทบาทด้าน Public Order Management ของ PRT และการฝึกร่วมกับ Central Response Unit และ Guadalcanal Police Response Unit ภายใต้การกำกับของ Director National Response Department" },
      { title: "AFP delivers additional support to RSIPF National Response Department and Fire & Rescue", publisher: "Royal Solomon Islands Police Force (rsipf.gov.sb)", url: "https://www.rsipf.gov.sb/?q=node/2806", type: "official", accessedAt: "2026-07-26", supports: ["branch", "role"], notes: "ข่าวทางการของ RSIPF ระบุภารกิจของ National Response Department ในการตอบสนองต่อเหตุความไม่สงบเพื่อคุ้มครองประชาชนและทรัพย์สิน และการสนับสนุนจาก Australian Federal Police ภายใต้ RAPPP (ใช้สนับสนุนเฉพาะสังกัดและบทบาท ไม่ใช้สนับสนุนรายการอุปกรณ์)" },
    ],
  },
  "Samoa::TRG": {
    branch: "Samoa Police, Prisons and Corrections Services",
    unitType: "Police tactical/specialist response section (not a military special forces unit)",
    status: "Active",
    reviewedOn: "2026-07-26",
    history: { summary: "หน่วยยุทธวิธีของตำรวจซามัวที่ฐานข้อมูลนี้ติดตามภายใต้รหัส TRG มีชื่อทางการว่า Tactical Operations Section (TOS) ตามที่ปรากฏในรายการหน่วยงานบนเว็บไซต์ทางการของ Samoa Police, Prisons and Corrections Services และในเอกสารเผยแพร่ของ Australian Federal Police ทั้งนี้ไม่พบหน่วยที่ใช้ชื่อ ‘Tactical Response Group’ ในโครงสร้างทางการของตำรวจซามัว ชื่อสาธารณะในเรกคอร์ดนี้จึงได้รับการแก้ไขให้ตรงกับชื่อทางการ ขณะที่รหัสหน่วยและ slug เดิมยังคงไว้เพื่อความต่อเนื่องของฐานข้อมูล หน่วยนี้เป็นหน่วยของตำรวจ มิใช่หน่วยรบพิเศษของกองทัพ เนื่องจากซามัวไม่มีกองทัพประจำการ บทบาทที่แหล่งทางการรองรับคือการคลี่คลายเหตุการณ์ความเสี่ยงสูงด้วยวิธีทางยุทธวิธีในฐานะหน่วยเผชิญเหตุเฉพาะทาง โดย AFP ระบุการฝึกร่วมกับ Tactical Response Team ของ AFP ภายใต้ Samoa Australia Police Partnership (SAPP) เพื่อเตรียมความพร้อมด้านการรักษาความปลอดภัยสำหรับการประชุม CHOGM ปี 2024 ทั้งนี้ปีจัดตั้ง โครงสร้างภายใน และกำลังพลของหน่วยยังไม่มีแหล่งทางการที่ตรวจสอบได้ จึงไม่ระบุไว้" },
    sources: [
      { title: "Policing Units", publisher: "Samoa Police, Prisons & Corrections Services (samoapolice.ws)", url: "https://www.samoapolice.ws/about/our-organisation/policing-units/", type: "official", accessedAt: "2026-07-26", supports: ["identity", "branch"], notes: "หน้าโครงสร้างองค์กรทางการของตำรวจซามัว ระบุ Tactical Operations Section เป็นหนึ่งในหน่วยงานในสังกัด และไม่ปรากฏหน่วยชื่อ Tactical Response Group จึงใช้เป็นหลักฐานยืนยันชื่อทางการและสังกัด (หน้าเว็บไม่ได้ให้คำอธิบายภารกิจของหน่วยไว้)" },
      { title: "Samoa Police members visit Australia to boost capability ahead of CHOGM", publisher: "Australian Federal Police (afp.gov.au)", url: "https://www.afp.gov.au/news-centre/media-release/samoa-police-members-visit-australia-boost-capability-ahead-chogm", type: "government", accessedAt: "2026-07-26", supports: ["identity", "role"], notes: "เอกสารเผยแพร่ของ AFP ซึ่งเป็นหน่วยงานรัฐบาลพันธมิตร ระบุชื่อหน่วยว่า Samoa Police Tactical Operations Section (TOS) สังกัด Samoa Police, Prisons and Corrections Services และบทบาทด้านการคลี่คลายเหตุการณ์ความเสี่ยงสูง รวมถึงการฝึกภายใต้ Samoa Australia Police Partnership" },
    ],
  },
};
